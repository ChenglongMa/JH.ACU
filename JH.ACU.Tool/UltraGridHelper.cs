...
namespace JH.ACU.Tool
{
    ...
    public static class UltraGridHelper
    {
            ...
            static void grid_KeyDown(object sender, KeyEventArgs e)
            {
                ...
                {
                    (sender as UltraGrid).PerformAction(UltraGridAction.Copy);
...
*/
            ...
            /// </summary>
            /// <param name="grid"></param>
            public static void AutoSizeAllCol(UltraGrid grid)
            {
                if (grid.DisplayLayout.Bands.Count == 0)
                    return;
            ...
            public static void DataColumn_Layout(UltraGridColumn ultraGridColumn, int VisiblePosition, int OriginX, int OriginY, int SpanY)
            {
            ...
            public static void NoDataColumn_Layout(UltraGridColumn ultraGridColumn, int VisiblePosition, int OriginX, int childColumCount)
            {
                ultraGridColumn.Header.VisiblePosition = VisiblePosition;
